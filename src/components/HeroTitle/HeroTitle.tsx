...
const HeroTitle = () => {
  return (    
      <div className="flex gap-5.5 flex-col max-h-full h-full lg:pl-10 px-5 lg:px-10">
        {/* <VideoPlayer /> */}
        <h1 className="font-second xs:max-w-150 lg:max-w-150 1xl:max-w-200 text-master-60">Природна турбота, що працює щодня</h1>
